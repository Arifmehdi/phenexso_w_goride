...
@section('sidebar')
    <li><a href="{{ route('owner.dashboard') }}" class="active"><i class="fas fa-chart-line"></i> <span>My Stats</span></a></li>
    <li><a href="#"><i class="fas fa-car-side"></i> <span>My Cars</span></a></li>
    <li><a href="#"><i class="fas fa-route"></i> <span>Trip History</span></a></li>
    <li><a href="#"><i class="fas fa-wallet"></i> <span>Earnings</span></a></li>
    <li><a href="#"><i class="fas fa-user-edit"></i> <span>Profile</span></a></li>
    <li><a href="#"><i class="fas fa-file-alt"></i> <span>Documents</span></a></li>

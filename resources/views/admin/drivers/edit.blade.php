                ...
                <div class="row py-2">
                    <div class="col-12 col-md-12 m-auto card p-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" placeholder="Email Address" name="email" value="{{ old('email', $driver->email) }}">
                            @error('email')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('license_no') is-invalid @enderror" placeholder="License Number" name="license_no" value="{{ old('license_no', $driver->license_no) }}">
                            @error('license_no')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nid') is-invalid @enderror" placeholder="NID Number" name="nid" value="{{ old('nid', $driver->nid) }}">
                            @error('nid')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3">{{ old('address', $driver->address) }}</textarea>
                            @error('address')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
